              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-blue-600 dark:text-blue-400">
                    ${Number(product.Precio ?? product.price ?? 0).toFixed(2)}
                  </p>
                </div>
  ...
  {(() => {
    ...
    return (
      <div
        ...
        className={`flex items-center gap-2 px-3 py-1 rounded-full cursor-pointer transition-all duration-300 ${bgColor}`}
      >
        {isAvailable ? (
          <>
