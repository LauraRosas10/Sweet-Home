...
export default function ProductList({ products, onEdit, onDelete, onToggleStatus }) {
        ...
        <div className="flex gap-5">
            ...
            <div className="flex items-start justify-between gap-4 mb-3">
                ...
                <button
                    ...
                    className="p-2.5 rounded-lg bg-red-100 dark:bg-slate-700 text-red-600 dark:text-red-400 hover:bg-red-200 dark:hover:bg-slate-600 transition-all duration-300 hover:scale-110"
                    title="Eliminar"
                >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                ...
                >
                    ...
                    <>
                        ...
                        <span className="text-sm font-semibold text-slate-500 dark:text-slate-400">Inactivo</span>
                    </>
                    )}
                </button>
                </div>
