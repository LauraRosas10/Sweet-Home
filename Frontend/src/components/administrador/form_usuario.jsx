...
return (
    ...
    <header className="sticky top-0 z-10 backdrop-blur-xl bg-white/95 dark:bg-slate-900/95 border-b border-slate-200 dark:border-slate-800 px-6 py-5">
        ...
        <button
            onClick={onCancel}
            className="inline-flex items-center justify-center size-10 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors duration-200"
            aria-label="Volver"
        >
            ←
        </button>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-col gap-4 items-center">
                ...
                {photoPreview && (
                    ...
                    className="absolute -top-2 -right-2 bg-red-500 hover:bg-red-600 text-white rounded-full w-8 h-8 flex items-center justify-center font-bold transition-colors duration-200"
            ...
            <label className="block text-sm font-semibold text-slate-900 dark:text-slate-50">Nombre Completo</label>
            <input
                type="text"
                name="name"
                value={formData.name}
            ...
            <select
                ...
                value={formData.role}
                onChange={handleChange}
                className="w-full px-4 py-3 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 appearance-none cursor-pointer"
            >
            ...
            <div className="flex gap-2">
                ...
                onChange={handleChange}
                placeholder="••••••••"
                className="flex-1 px-4 py-3 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-50 placeholder:text-slate-400 dark:placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                />
                <button
                type="button"
    ...
    <footer className="sticky bottom-0 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border-t border-slate-200 dark:border-slate-800 px-6 py-4">
        ...
        <button
            ...
            className="flex-1 h-12 px-6 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold transition-all duration-200 hover:shadow-lg hover:shadow-blue-600/20 active:scale-95"
        >
            {initialData ? "Actualizar Usuario" : "Crear Usuario"}
        </button>
        <button
            onClick={onCancel}
            className="flex-1 h-12 px-6 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-slate-50 font-semibold hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors duration-200"
        >
            Cancelar
        </button>
        </div>
